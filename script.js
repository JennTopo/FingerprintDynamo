...
as well as the possible choices in letters, digits and speical characters. */

var passwordlenght = (i=0)[i>8 & i < 128];
...
password = password + choice [randomizer]; // this line conccatinate the randomizer and the possible options to create the fingerPrint
}
return password;
}
getPrompt();{
